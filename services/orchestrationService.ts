...
export const processStep = async (
    ...
    const prompt = constructPrompt(history, step, bookState, shouldApplyGoldenRule(step));
    ...
    try {
        ...
        // Ensure a valid, user-friendly error object is always returned
